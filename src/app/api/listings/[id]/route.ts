  ...
  try {
    ...
    const updated = await prisma.listing.update({
      ...
      data: {
        ...
        ...(data.councilRates !== undefined ? { councilRates: data.councilRates } : {}),
        ...(data.waterRates !== undefined ? { waterRates: data.waterRates } : {}),
        ...(data.occupancyType !== undefined ? { occupancyType: data.occupancyType } : {}),
        ...(data.reasonForSelling !== undefined ? { reasonForSelling: data.reasonForSelling } : {}),
        ...(data.currentRentalAmount !== undefined ? { currentRentalAmount: data.currentRentalAmount } : {}),
        ...(data.titleType !== undefined ? { titleType: data.titleType } : {}),
        ...(data.bodyCorporateFees !== undefined ? { bodyCorporateFees: data.bodyCorporateFees } : {}),
        ...(data.inspectionTimes !== undefined ? { inspectionTimes: data.inspectionTimes ?? Prisma.JsonNull } : {}),
        ...(data.buildingPestReportUrl !== undefined ? { buildingPestReportUrl: data.buildingPestReportUrl } : {}),
